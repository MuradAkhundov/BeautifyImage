package com.muradakhundov.beautifyimage.viewmodel
...
class EditImageViewModel(private val editImageRepository: EditImageRepository) : ViewModel() {
    ...
    val imageFiltersUiState: LiveData<ImageFiltersDataState> get() = imageFiltersDataState // Corrected LiveData variable name
